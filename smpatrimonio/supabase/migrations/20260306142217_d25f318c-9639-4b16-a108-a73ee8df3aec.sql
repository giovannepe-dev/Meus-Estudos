...
-- Fix ALL RLS policies to be PERMISSIVE for items table
...
CREATE POLICY "Admin/Patrimonio can manage items" ON public.items
...
CREATE POLICY "Authenticated can view items" ON public.items
...
CREATE POLICY "Admin/Patrimonio can manage categories" ON public.categories AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin/Patrimonio can manage rooms" ON public.rooms AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin/Patrimonio can manage kits" ON public.kits AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin/Patrimonio can manage kit items" ON public.kit_items AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin/Patrimonio can create movements" ON public.movements AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin/Patrimonio can manage maintenances" ON public.maintenances AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin/Patrimonio/Inventario can manage inventories" ON public.inventories AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role) OR has_role(auth.uid(), 'inventario'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role) OR has_role(auth.uid(), 'inventario'::app_role));
...
CREATE POLICY "Admin/Patrimonio/Inventario can insert scans" ON public.inventory_scans AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role) OR has_role(auth.uid(), 'inventario'::app_role));
...
CREATE POLICY "Admin/Patrimonio can manage attachments" ON public.item_attachments AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Authenticated can insert audit logs" ON public.item_audit_logs AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (usuario_id = auth.uid());
...
CREATE POLICY "Admin/Patrimonio can manage units" ON public.units AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin/Patrimonio can manage sectors" ON public.sectors AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role) OR has_role(auth.uid(), 'patrimonio'::app_role));
...
CREATE POLICY "Admin can manage settings" ON public.app_settings AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admin can manage label templates" ON public.label_templates AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admin can manage printer profiles" ON public.printer_profiles AS PERMISSIVE FOR ALL TO authenticated USING (has_role(auth.uid(), 'admin'::app_role)) WITH CHECK (has_role(auth.uid(), 'admin'::app_role));
