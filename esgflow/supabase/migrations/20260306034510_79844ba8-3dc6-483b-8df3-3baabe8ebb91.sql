...
-- Indicators table (definitions)
CREATE TABLE public.indicators (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  company_id UUID NOT NULL REFERENCES public.companies(id) ON DELETE CASCADE,
  name TEXT NOT NULL,
  category TEXT NOT NULL CHECK (category IN ('ambiental', 'social', 'governanca')),
  unit TEXT NOT NULL,
...
-- Indicator values (monthly data entries)
...
CREATE POLICY "Authenticated users can view values" ON public.indicator_values FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can insert values" ON public.indicator_values FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Authenticated users can update values" ON public.indicator_values FOR UPDATE TO authenticated USING (true);
CREATE POLICY "Authenticated users can delete values" ON public.indicator_values FOR DELETE TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can view evidences" ON public.evidences FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can insert evidences" ON public.evidences FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "Authenticated users can update evidences" ON public.evidences FOR UPDATE TO authenticated USING (true);
CREATE POLICY "Authenticated users can delete evidences" ON public.evidences FOR DELETE TO authenticated USING (true);
